  ...
  CardNextStepScreen: {
    ...
    steps: {
      one: {
        ...
        description: "KYC verification and application submission",
      },
      two: {
        title: "Subscribe and pay",
        description: "Once approved, you pay $1,000 by lightning",
      },
      three: {
        title: "Wait",
        description: "We expect to be ready by end of Q4 2025",
      },
      four: {
        title: "Activate card",
        description: "We will notify you in the Blink app when the card is ready",
      },
    }
  },
}
